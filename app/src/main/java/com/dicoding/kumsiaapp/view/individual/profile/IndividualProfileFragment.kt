 ...
 * Use the [IndividualProfileFragment.newInstance] factory method to
...
class IndividualProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment IndividualProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            IndividualProfileFragment().apply {
